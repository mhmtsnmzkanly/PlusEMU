...
public static class ClientPacketHeader
{
    ...
    public const uint GuideVisitUserEvent = 1052; // inferred from Arcturus guide mapping
    public const uint GuideInviteUserEvent = 234; // inferred from Arcturus guide mapping
