...
public class SettingsManager : ISettingsManager
{
    ...
    [
        ...
        new("camera.enabled", SettingsValueType.Bool, Owner: "Camera"),
        new("camera.item_id", SettingsValueType.Int, Min: 0, Owner: "Camera"),
        new("camera.price.credits", SettingsValueType.Int, Min: 0, Owner: "Camera"),
        new("camera.price.points", SettingsValueType.Int, Min: 0, Owner: "Camera"),
        new("camera.price.points.publish", SettingsValueType.Int, Min: 0, Owner: "Camera"),
        new("camera.publish.delay", SettingsValueType.Int, Min: 0, Owner: "Camera"),
        new("camera.url.base", SettingsValueType.String, Owner: "Camera"),
